...
# Plot file
Getting the bounding box of the ten plants, that were hand measured during the growing season
...
Calculating the different height parameters like, mean, max, minimum, median 
